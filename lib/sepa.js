...
(function(exports) {
  ...
  SepaGroupHeader.prototype = {
    ...
    toXML: function(doc) {
      ...
      r(grpHdr, 'CreDtTm', this.created.toISOString().substring(0, 19));
  ...
  SepaPaymentInfo.prototype = {
    ...
    toXML: function(doc) {
      ...
      if (this.purpose) {
        r(pmtTpInf, 'CtgyPurp', this.purpose);
      }
      ...
      if (this[pullFrom + 'BankPartyId']) {
        r(emitter, 'Id', 'OrgId', 'BkPtyId', this[pullFrom + 'BankPartyId']);
      }
  ...
  SepaTransaction.prototype = {
    ...
    toXML: function(doc) {
      ...
      if (this.remittanceInfo && this.remittanceInfo !== '') {
        var rmtInf = n(txInf, 'RmtInf');
        var stdr = n(rmtInf, 'Strd');
        var cdtrRefInf = n(stdr, 'CdtrRefInf');
        var cdtrRefTp = n(cdtrRefInf, 'CdtrRefTp');
        r(cdtrRefTp, 'Cd', 'SCOR');
        r(cdtrRefInf, 'CdtrRef', this.remittanceInfo);
      }
